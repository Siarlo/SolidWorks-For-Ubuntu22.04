...
function SP_SOLIDWORKS_INSTALL {
  ...
  dialog --infobox "This script will now install required winetricks packages. This will take several minutes..." 10 50
  sleep 5

   cd "$SP_PATH/bin/winetricks"
   WINEPREFIX=$SP_PATH/wineprefixes/solidworks $SP_PATH/bin/winetricks -q atmlib gdiplus dotnet48 corefonts msxml3 msxml4 msxml6 vcrun2019 ie8 dxvk win10 &&
   WINEPREFIX=$SP_PATH/wineprefixes/solidworks $SP_PATH/bin/winetricks -q win10 &&
